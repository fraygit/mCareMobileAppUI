angular.module('mcareApp').controller('PatientProfileController', ['$scope', '$http', 'SessionService', function ($scope, $http, SessionService) {
    ...
    //var FHdata = {
    //    labels: [new Date(2016, 5, 1), new Date(2016, 5, 15), new Date(2016, 5, 31), new Date(2016, 6, 1), new Date(2016, 6, 14)],
    //    datasets: [
    //        {
    //            backgroundColor: 'rgba(54, 162, 235, 0.2)',
    //            borderColor: 'rgba(54, 162, 235, 1)',
    ...
    //        }]
    //};
    //var chtFHEl = document.getElementById("chtFH");
    //var chtFH = new Chart(chtFHEl, {
    //    type: 'line',
    //    data: FHdata,
    //    options: {
    //        scales: {
